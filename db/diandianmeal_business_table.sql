...
CREATE TABLE `business_table` (
  ...
  CONSTRAINT `BTUsername` FOREIGN KEY (`Username`) REFERENCES `business_info` (`Username`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `business_table` VALUES ('ojxf_0AsqbzLf7RAJRncnIGopDbw','桌位1'),('ojxf_0GFPn4WMjQJ87snxD0lXV-8','2'),('ojxf_0HeOwRJXWcSB1KkMnlaKVhI','123'),('ojxf_0HeOwRJXWcSB1KkMnlaKVhI','小餐厅01');
